...
% along the negative z-axis of the grid. This vector will be almost
% parallel to the camera z-axis.
...
% Define a unit vector pointing at the object origin.
...
% Normalize again (no need to check norm)
